...
if($_POST){
    if($_POST['aksi'] == 'tambah'){
        ...
        $tanggal_akhir=$_POST['tambah_akhir'];

        $sql="INSERT INTO periode (id_periode,periode,tanggal_awal,tanggal_akhir,
        dibuat_pada,diubah_pada,dihapus_pada) VALUES(DEFAULT,'$periode',
        '$tanggal_awal','$tanggal_akhir',DEFAULT,DEFAULT,DEFAULT)";
        ...
        $sql="UPDATE periode SET periode='$periode',
