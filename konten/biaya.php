            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <table id="example1" class="table table-hover">
                        ...
                        <?php
                $sql="SELECT biaya.*,periode.periode,jurusan.jurusan FROM biaya,periode,jurusan WHERE biaya.dihapus_pada IS NULL AND 
                biaya.id_periode=periode.id_periode AND biaya.id_jurusan=jurusan.id_jurusan";
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a
                                    ...
                                    href="aksi/biaya.php?aksi=hapus&id_biaya=
                                <?= $kolom['id_biaya'];?>">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          ?>
                    ...
                    <input type="text" name="jumlah_biaya" class="form-control" required="required">
