        ...
        <div class="card-body">
          <form action="aksi/bayar.php" method="post" enctype="multipart/form-data">
            ...
            <textarea name="keterangan" class="form-control" rows="3"
              placeholder="Isi dengan keterangan pembayaran seperti nama bank,nama pengirim,dll"></textarea>
            ...
            <input type="number" name="nominal_bayar" class="form-control" required="required">
