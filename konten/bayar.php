        ...
        <span class="<?= $class; ?>">
            <?= $kolom['status_verifikasi']; ?>
                                ...
                                <td> <!-- 05 September 2023 --> 
                                    ...
                                    <a onclick="return confirm('Yakin akan mengkonfirmasi pembayaran ini?')" 
                                    href="index.php?p=bayar-konfirmasi&id_bayar=<?= $kolom['id_bayar'];?>" title="Konfirmasi Pembayaran"><i class="fas fa-check"></i></a>
                                    <?php } ?> 
                                    <!-- Tombol Hapus  -->
                                    <a onclick="return confirm('Yakin akan menghapus data ini?')" 
                                    href="aksi/bayar.php?aksi=hapus&id_bayar=<?= $kolom['id_bayar']; ?>" title="Hapus Pembayarann"><i class="fas fa-trash"></i></a>
                                </td>
                            </tr>
<!-- Modal Ubah Biaya -->
