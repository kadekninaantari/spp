...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="card">
                ...
                AND tagihan.id_siswa=siswa.id_siswa AND tagihan.id_biaya=biaya.id_biaya AND biaya.id_periode=periode.id_periode AND tagihan.id_siswa=$id_siswa";
    ...
    <td>
                                ...
                                <a 
                                title="Informasi Riwayat Tagihan"
                                 href="index.php?p=bayar-alokasi-siswa&id_bayar=<?=$kolom['id_bayar']; ?>"><i class="fas fa-search"></i></a>
    </td>
