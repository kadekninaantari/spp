      ...
      <div class="card">
        ...
        <div class="card-body">
          <form action="aksi/bayar.php" method="post" enctype="multipart/form-data">
            ...
            <div class="row">
              <div class="col-md-6">
                <label for="id_siswa">No.Pembayaran</label>
            ...
            <div class="row">
              <div class="col-md-6">
                ...
                <input type="date" name="tanggal_bayar" class="form-control" readonly
                  value="<?= $bayar['tanggal_bayar']; ?>">
              </div>
              <div class="col-md-6">
                <label for="nominal_pembayaran">Nominal Pembayaran</label>
                <input type="text" name="nominal_bayar" class="form-control text-right"
                  value="<?= number_format($bayar['nominal_bayar']); ?>" readonly>
              </div>
            </div>
          </form>
        </div>
        ...
        <div class="card-body">
          <table class="table table-bordered">
            <thead>
              ...
              <?php
                            $sql="SELECT bayar_alokasi.*,biaya.deskripsi_biaya FROM 
                            bayar_alokasi,tagihan,biaya WHERE  bayar_alokasi.
                            id_tagihan=tagihan.id_tagihan AND tagihan.id_biaya=biaya.
                            id_biaya AND bayar_alokasi.id_bayar=$id_bayar";
                            // echo $sql;
                            $query=mysqli_query($koneksi,$sql);
