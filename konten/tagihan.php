            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <table id="example1" class="table table-hover table-sm">
                        ...
                        <?php
                $sql="SELECT tagihan.*,siswa.nis,siswa.nama,biaya.deskripsi_biaya,biaya.jumlah_biaya,biaya.tanggal_jatuh_tempo,periode.periode FROM tagihan,siswa,biaya,periode WHERE tagihan.dihapus_pada IS NULL
                AND tagihan.id_siswa=siswa.id_siswa AND tagihan.id_biaya=biaya.id_biaya AND biaya.id_periode=periode.id_periode";
                        ...
                        <tr>
                            ...
                            <td><!--05 september 2023-->
                                ...
                                title="Informasi Riwayat Tagihan"
                                 href="index.php?p=tagihan-info&id_tagihan=<?=$kolom['id_tagihan']; ?>"><i class="fas fa-search"></i></a>
                                &nbsp;
                                <!--Tombol Edit-->
                                <a title="Ubah Tagihan"
              ...
              ?>
                    ...
                    <button
                        ...
                        <i class="fas fa-plus"></i>Tambah Data Biaya</button>
                </div>
            </div>
        ...
        <div class="modal-content">
          ...
          ?>
                    ...
                    class="form-control" required>
                            ...
                            <?php
                                $sql_jurusan="SELECT * FROM jurusan WHERE dihapus_pada IS
                                NULL ORDER BY jurusan ASC";
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btnn btn-secondary" data-dismiss="modal">Close</button>
                    </div>
                </form>
            </div>
        </div>
                    ...
                    <tr>
                        ...
                        <td>
                            <a
                                ...
                                href="aksi/biaya.php?aksi=restore&id_biaya=
                                <?= $kolom['id_biaya'];?>">
                            ...
                            <a
                                ...
                                href="aksi/biaya.php?aksi=hapus-permanen&id_biaya=
                                <?= $kolom['id_biaya'];?>">
