...
$pdf->setSubject('Laporan Pembayaran Umum');
$pdf->setKeywords('Laporan Pembayaran Umum');

// set default header data
$pdf->setHeaderData(PDF_HEADER_LOGO, PDF_HEADER_LOGO_WIDTH, 'SIP 1.0'.' 006', PDF_HEADER_STRING);
...
$html = '
<p align="center"><strong><bold>Laporan Pembayaran Umum
</strong></b></p><br>
